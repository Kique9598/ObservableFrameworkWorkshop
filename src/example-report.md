...
This report is a <span style="background: linear-gradient(transparent, cyan)"> brief overview </span> of the history and current state of rocket launches and space exploration.
